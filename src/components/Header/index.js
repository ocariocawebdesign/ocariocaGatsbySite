        ...
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div className="centralizar">
              <img className="img-fluid img-perfil" src={Ocarioca} alt="" />
            </div>
            <p className="text-letf p-sobre">
            ...
            <div className="centralizar">
              <a
                ...
                target="_blank"
                rel="noreferrer"cacak7

              >
                <button className="btn btn-primary-mod-02 text-button-size">
